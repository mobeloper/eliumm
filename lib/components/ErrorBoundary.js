...
var _RouteButtons = _interopRequireDefault(require("./RouteButtons"));
var _fetchRoutes = _interopRequireDefault(require("../utils/fetchRoutes"));
...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); } // import React, { Component } from 'react';
  ...
  return _createClass(ErrorBoundary, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              console.error('Error fetching routes:', _context.t0);
            case 10:
            case "end":
    ...
    value: function render() {
      if (this.state.hasError) {
        ...
        }, "Something went wrong"), /*#__PURE__*/_react["default"].createElement("p", {
          className: "mb-4"
        }, this.state.error ? this.state.error.message : 'An error occurred'), /*#__PURE__*/_react["default"].createElement(_RouteButtons["default"], {
